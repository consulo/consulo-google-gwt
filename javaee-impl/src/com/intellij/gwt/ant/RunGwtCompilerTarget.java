...
{
	private final JavaEEGoogleGwtModuleExtension myFacet;

	public RunGwtCompilerTarget(JavaEEGoogleGwtModuleExtension facet, final GenerationOptions genOptions)
	{
	...
	private void addJavaTag(final GenerationOptions genOptions)
	{
		...
		java.add(jvmarg("-Xmx" + String.valueOf(myFacet.getCompilerMaxHeapSize()) + "m"));
		String jvmParameters = myFacet.getAdditionalCompilerParameters();
		...
		java.add(arg(myFacet.getOutputStyle().getId()));
