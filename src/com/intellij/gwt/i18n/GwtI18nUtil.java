...
public class GwtI18nUtil {
  ...
  @NonNls public static final String LOCALIZABLE_INTERFACE_NAME = "com.google.gwt.i18n.client.LocalizableResource";
  @NonNls private static final String GWT_PROPERTY_KEY_JAVADOC = "/**\n*@gwt.key {0}\n*/";
  @NonNls public static final String KEY_ANNOTATION_CLASS = "com.google.gwt.i18n.client.LocalizableResource.Key";
  @NonNls public static final String GWT_KEY_TAG = "gwt.key";
  ...
  public static PsiMethod addMethod(PsiClass aClass, String propertyName, final GwtVersion gwtVersion) throws IncorrectOperationException {
    ...
    String methodName = convertPropertyName2MethodName(propertyName, JavaPsiFacade.getInstance(psiManager.getProject()).getNameHelper(), PsiUtil.getLanguageLevel(aClass));
    ...
    if (!propertyName.equals(methodName)) {
      if (gwtVersion.isGenericsSupported()) {
        ...
        PsiComment comment =
            elementFactory.createCommentFromText(commentText, aClass);
