...
public class GwtSdkPathEditor
{
	...
	public GwtSdkPathEditor(@Nullable Project project)
	{
		...
		myPathEditor.addBrowseFolderListener(GwtBundle.message("gwt.installation.chooser.title"), GwtBundle.message("gwt.installation.chooser" +
				".description"), project, BrowseFilesListener.SINGLE_DIRECTORY_DESCRIPTOR, TextComponentAccessor.STRING_COMBOBOX_WHOLE_TEXT);
