...
public class GwtFacetConfiguration implements FacetConfiguration, PersistentStateComponent<GwtFacetConfiguration.GwtFacetState> {
  ...
  @NonNls private static final String COMPILER_OUTPUT_PATH_ATTRIBUTE = "compilerOutputPath";
  ...
  @NonNls private static final String ADDITIONAL_COMPILER_PARAMETERS_ATTRIBUTE = "additionalCompilerParameters";
