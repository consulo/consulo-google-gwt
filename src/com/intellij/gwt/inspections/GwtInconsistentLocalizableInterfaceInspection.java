...
public class GwtInconsistentLocalizableInterfaceInspection extends BaseGwtInspection {
  ...
  private static @Nullable ProblemDescriptor[] checkPropertiesFile(final InspectionManager manager, final PropertiesFile propertiesFile,
                                                                   final GwtFacet gwtFacet) {
    final GwtI18nManager i18nManager = GwtI18nManager.getInstance(manager.getProject());
    ...
    for (Property property : propertiesWithoutMethods) {
        ...
        LocalQuickFix[] fixes = synchAllQuickfix == null ? new LocalQuickFix[]{quickFix} : new LocalQuickFix[]{synchAllQuickfix, quickFix};
  ...
  private static class AddMethodToInterfaceQuickFix extends BaseGwtLocalQuickFix {
    ...
    public AddMethodToInterfaceQuickFix(final PsiClass anInterface, final String propertyName, final String value,
