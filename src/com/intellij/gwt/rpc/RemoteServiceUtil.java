...
public class RemoteServiceUtil {
  ...
  @NonNls private static final String REMOTE_SERVICE_INTERFACE_NAME = "com.google.gwt.user.client.rpc.RemoteService";
  @NonNls public static final String ASYNC_CALLBACK_INTERFACE_NAME = "com.google.gwt.user.client.rpc.AsyncCallback";
  @NonNls private static final String REMOTE_SERVICE_SERVLET_NAME = "com.google.gwt.user.server.rpc.RemoteServiceServlet";
  @NonNls public static final String ASYNC_SUFFIX = "Async";
  @NonNls public static final String IMPL_SERVICE_SUFFIX = "Impl";
  @NonNls private static final String VOID_CLASS_NAME = "java.lang.Void";
  ...
  public static boolean isRemoteServiceInterface(final @Nullable PsiClass aClass) {
    ...
    final PsiClass remoteService =
      JavaPsiFacade.getInstance(aClass.getProject()).findClass(REMOTE_SERVICE_INTERFACE_NAME, aClass.getResolveScope());
  ...
  public static @Nullable PsiClass findSynchronousInterface(final PsiClass asynchInterface) {
