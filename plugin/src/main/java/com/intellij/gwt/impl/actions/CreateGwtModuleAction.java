...
public class CreateGwtModuleAction extends GwtCreateActionBase {
    public CreateGwtModuleAction() {
        super(GwtLocalize.newmoduleMenuActionText(), GwtLocalize.newmoduleMenuActionDescription());
    }
    ...
    protected LocalizeValue getDialogPrompt() {
        return GwtLocalize.newmoduleDlgPrompt();
    }

    @Override
    protected LocalizeValue getDialogTitle() {
        return GwtLocalize.newmoduleDlgTitle();
    }
    ...
    protected LocalizeValue getCommandName() {
        return GwtLocalize.newmoduleCommandName();
    }

    @Override
    protected LocalizeValue getActionName(PsiDirectory directory, String newName) {
        return GwtLocalize.newmoduleProgressText(newName);
    }
}
