...
public class GwtDeprecatedPropertyKeyJavadocTagInspection extends BaseGwtInspection {
        ...
        for (PsiMethod method : anInterface.getMethods()) {
            ...
            if (comment != null) {
                ...
                if (tag != null) {
                    ...
                    LocalizeValue message = GwtLocalize.problemDescriptionGwtKeyTagIsDeprecatedInGwt15();
                    problems.add(manager.createProblemDescriptor(tag, message.get(), fix, ProblemHighlightType.GENERIC_ERROR_OR_WARNING));
                }
            }
        }
    ...
    public LocalizeValue getDisplayName() {
        return GwtLocalize.inspectionNameDeprecatedGwtKeyTagInJavadocComments();
    }
    ...
    private static class ReplaceTagByAnnotationQuickFix extends BaseGwtLocalQuickFix {
        ...
        public ReplaceTagByAnnotationQuickFix(final PsiDocTag tag, final PsiMethod method) {
            super(GwtLocalize.quickfixNameReplaceGwtKeyTagWithKeyAnnotationInMethod0(PsiFormatUtil.formatMethod(method,
