...
public class CreateGwtSampleAppAction extends GwtCreateActionBase {
    ...
    public CreateGwtSampleAppAction() {
        super(GwtLocalize.newappMenuActionText(), GwtLocalize.newappMenuActionDescription());
    }
    ...
    protected LocalizeValue getDialogPrompt() {
        return GwtLocalize.newappDlgPrompt();
    }

    @Override
    protected LocalizeValue getDialogTitle() {
        return GwtLocalize.newappDlgTitle();
    }
    ...
    protected void doCheckBeforeCreate(String name, PsiDirectory directory) throws IncorrectOperationException {
        ...
        if (!version.isGenericsSupported()) {
            final LocalizeValue message = GwtLocalize.errorMessageSampleApplicationRequiresGwt15OrLater();
    ...
    protected LocalizeValue getCommandName() {
        return GwtLocalize.newappCommandName();
    }

    @Override
    protected LocalizeValue getActionName(PsiDirectory directory, String newName) {
        return GwtLocalize.newappProgressText(newName);
    }
}
